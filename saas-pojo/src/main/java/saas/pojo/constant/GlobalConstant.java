...
public class GlobalConstant {
    ...
    public static final String SIM_PROFILE = "sim";

    public static final int TWO_INT = 2;
    public static final int M_SIZE = 1024;
    public static final String ROOT_PREFIX = "saas";

    public static final int EXCEPTION_CAUSE_MAX_LENGTH = 2048;
    public static final int EXCEPTION_MESSAGE_MAX_LENGTH = 2048;

    public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/saas/registry/service";
    public static final String ZK_REGISTRY_ID_ROOT_PATH = "/saas/registry/id";
    public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/saas/registry/producer";
    public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/saas/registry/consumer";
    public static final String ZK_REGISTRY_SEQ = "/saas/seq";
    ...
    public static final class Sys {
         ...
         */
        public static final String DEFAULT_FILE_PATH = "saas/file/";
